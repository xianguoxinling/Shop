...
public class UnChooseProductionFromCartController implements Controller
{
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        int result = cartService.unChooseProduction(id, userID, keyID);
        if(MAGICCODE.OK != result)
        {
            map.put("code", MAGICCODE.MAGIC_ERROR);
        }else
        {
            int num = cartService.queryCartNum(userID, keyID);
            map.put("num",  new Integer(num).toString());
